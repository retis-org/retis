...
```none
$ retis -p pcap,generic collect -o retis.data
$ retis pcap --probe tp:net:netif_receive_skb retis.data | tcpdump -nnr -
$ retis pcap --probe tp:net:net_dev_start_xmit -o retis.pcap retis.data
