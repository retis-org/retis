...
pub(super) fn bench(ci: bool) -> Result<()> {
    ...
    let data = [
        ...
        0, 0, 0, 2, 0, 0, 0, 2, 0, 0, 0, 7, 8, 4, 0, 24, 2, 0, 240, 7, 9, 20, 0, 52, 0, 0, 0, 0, 0,
        0, 0, 81, 195, 166, 219, 0, 0, 0, 0, 0, 0, 0, 0, 7, 10, 5, 0, 0, 0, 0, 1, 1, 7, 0, 14, 0,
        198, 63, 108, 52, 129, 40, 6, 150, 71, 156, 160, 68, 8, 0, 7, 2, 19, 0, 1, 1, 1, 1, 10, 0,
        42, 2, 0, 52, 184, 0, 6, 55, 0, 0, 0, 0, 2, 7, 4, 16, 0, 1, 187, 203, 190, 214, 204, 195,
