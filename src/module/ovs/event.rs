...
impl EventFormat for OvsEvent {
    fn to_string(&self) -> String {
        format!("ovs: {}", self.event.to_string())
    }
}
...
impl OvsEventType {
    ...
    fn to_string(&self) -> String {
        use OvsEventType::*;
        match self {
            Upcall(e) => e.to_string(),
            UpcallEnqueue(e) => e.to_string(),
            UpcallReturn(e) => e.to_string(),
            RecvUpcall(e) => e.to_string(),
            Operation(e) => e.to_string(),
            Action(e) => e.to_string(),
            Undefined => "?".to_string(),
        }
    }
}
