...
lint-ebpf:
	...
	ignore="SPDX_LICENSE_TAG,FILE_PATH_CHANGES,EMAIL_SUBJECT,VOLATILE,MACRO_WITH_FLOW_CONTROL,MACRO_ARG_UNUSED,COMMIT_LOG_LONG_LINE,COMMIT_MESSAGE,NOT_UNIFIED_DIFF,GLOBAL_INITIALISERS"; \
