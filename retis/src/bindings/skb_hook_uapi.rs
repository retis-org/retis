...
pub type u32_ = __u32;
pub type u64_ = __u64;
pub const SECTION_PACKET: skb_opts = 1;
pub const SECTION_DEV: skb_opts = 2;
pub const SECTION_NS: skb_opts = 3;
pub const SECTION_META: skb_opts = 4;
pub const SECTION_DATA_REF: skb_opts = 5;
pub const SECTION_GSO: skb_opts = 6;
pub type skb_opts = ::std::os::raw::c_uint;
#[repr(C)]
