...
pub const ETHERNET: packet_kind = 0;
pub const FAKE_ETHERNET: packet_kind = 1;
pub const IPV4: packet_kind = 2;
pub const IPV6: packet_kind = 3;
pub type packet_kind = ::std::os::raw::c_uint;
