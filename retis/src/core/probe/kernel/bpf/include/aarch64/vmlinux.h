...
struct frame_record_meta {
	struct frame_record        record;               /*     0    16 */
	u64                        type;                 /*    16     8 */
...
struct device {
	...
	u64 *                      dma_mask;             /*   568     8 */
	/* --- cacheline 9 boundary (576 bytes) --- */
	u64                        coherent_dma_mask;    /*   576     8 */
	u64                        bus_dma_limit;        /*   584     8 */
	const struct bus_dma_region  * dma_range_map;    /*   592     8 */
	struct device_dma_parameters * dma_parms;        /*   600     8 */
	struct list_head           dma_pools;            /*   608    16 */
	struct dma_coherent_mem *  dma_mem;              /*   624     8 */
	...
	bool                       dma_coherent:1;       /*   748: 5  1 */
	bool                       dma_skip_sync:1;      /*   748: 6  1 */
	bool                       dma_iommu:1;          /*   748: 7  1 */

	/* size: 752, cachelines: 12, members: 48 */
	/* padding: 3 */
