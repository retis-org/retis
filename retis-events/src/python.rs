...
use pyo3::{
    ...
    prelude::*,
    types::{IntoPyDict, PyBool, PyList, PyString},
};
...
impl PyEvent {
    ...
    fn __getitem__<'a>(&'a self, py: Python<'a>, attr: &str) -> PyResult<Py<PyAny>> {
        warn!("Deprecation warning: The use of __getitem__ is deprecated in favor of direct attribute access");
        let item = self
            .__getattr__(py, attr)
    ...
    fn __contains__<'a>(&'a self, py: Python<'a>, attr: &str) -> PyResult<bool> {
        warn!(
            "Deprecation warning: The use of __contains__ is deprecated in favor of direct attribute access"
        );
